...
<div class="tab-page" id="tabPage5">
    ...
    <table border="0" cellspacing="0" cellpadding="3">
        ...
        <td>
          <div style="float:right;"><img name="login_logo" style="max-height: 48px" src="<?php echo !empty($login_logo) ? MODX_SITE_URL . $modx->htmlspecialchars($login_logo) : $_style['tx']; ?>" /></div>
          <input name="login_logo" id="login_logo" type="text" maxlength="100" style="width: 200px;" value="<?php echo !empty($login_logo) ? $modx->htmlspecialchars($login_logo) : ''; ?>" /><input type="button" value="<?php echo $_lang['insert']; ?>" onclick="BrowseServer('login_logo')" />
      ...
      <tr>
        ...
        <td>
          <div style="float:right;"><img name="login_bg" style="max-height: 48px" src="<?php echo !empty($login_bg) ? MODX_SITE_URL . $modx->htmlspecialchars($login_bg) : $_style['tx']; ?>" /></div>
          <input name="login_bg" id="login_bg" type="text" maxlength="100" style="width: 200px;" value="<?php echo !empty($login_bg) ? $modx->htmlspecialchars($login_bg) : ''; ?>" /><input type="button" value="<?php echo $_lang['insert']; ?>" onclick="BrowseServer('login_bg')" />
